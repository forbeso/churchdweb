  ...
  return (
    <>
      <div className="d-flex justify-content-between animate__animated animate__fadeIn">
        <div className="bg-white  p-3 chart-container">
      ...
      <div className="mt-3 d-flex justify-content-between animate__animated animate__fadeInUp mb-3">
        <div className="bg-white p-3 chart-container w-50">
          <div>
        ...
        <div className="bg-white p-3 target-reality">
          <div>
      ...
      <div className="d-flex justify-content-between animate__animated animate__fadeInUp mb-3">
        <div className="bg-white  p-3 chart-container-second">
          <div>
            <h6>Total Tithes</h6>
          </div>
